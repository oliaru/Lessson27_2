...
select * from praktika_2.Employee;
select * from praktika_2.reward;

select Employee.First_name, Employee.Last_name from praktika_2.Employee
join praktika_2.reward on Employee.Employee_id = reward.Employee_ref_id;

select Departement from praktika_2.Employee
join praktika_2.reward on Employee.Employee_id = reward.Employee_ref_id;

select Departement from praktika_2.Employee
where Departement like '%nce'

select * from praktika_2.Employee
left join praktika_2.reward on Employee.Employee_id = reward.Employee_ref_id;
